...
void ParticleCommon::CreateRootSignature() {
	...
	descriptorRanges[0].BaseShaderRegister = 0;//0から始まる
	...
	// パーティクルデータ用
	descriptorRanges[1].BaseShaderRegister = 0; // t1
	...
	rootParameters[0].DescriptorTable.pDescriptorRanges = &descriptorRanges[0];//Tableの中身の配列を指定
	rootParameters[0].DescriptorTable.NumDescriptorRanges = 1;//Tableで利用する数
	//パーティクル
	rootParameters[1].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;//DescriptorTableを使う
	rootParameters[1].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;//VertexShaderで使う
	rootParameters[1].DescriptorTable.pDescriptorRanges = &descriptorRanges[1];//Tableの中身の配列を指定
...
void ParticleCommon::CreateGraphicsPipeline() {
	...
	for (UINT i = 0; i < 4;i++) {
		inputElementDescs[3 + i].SemanticName = "UVTRANSFORM";
		...
		if (i == 0) {
			inputElementDescs[3 + i].AlignedByteOffset = 0;
		}
